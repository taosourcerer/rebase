...
The feeling that something is fundamentally wrong with you.
...
Parts of our brain are primitive.\\
...
The only thing you can commit to is doing it right now.
...
When one part of you wants to do something and another part is resisting, think about the following.
...
Life is a vast ocean of neverending tasks and problems.
The only question is: which problems do you wish to have?
Play for fun, not to win.
...
Notice when a behavior becomes an addiciton.
...
\begin{center}
\textit{Much unhappiness has come into the world because of things left unsaid.}
\end{center}
...
Other times, you can't change what you feel.
Sometimes the original emotion is still there.
Even though you think it's irrational feel that way.
...
That what is repressed the mostly is the dark side, your shadow, the ugly emotions, which we are afraid to even experience.
...
In case they truly can't be solved and are a big deal, remove that person from your life.
...
\textbf{Noone is allowed to fuck with you}.
...
Noone is allowed to treat you like you're a loser.
...
% the abilities of others are limited, they are like children
...
%1) Assume, for no particular reason, other people dislike you.
%2) Convince yourself that you don’t care about opinons of others. After a while, it sort of even becomes true, but never completely true.
%3) As a consequence, your actions start to hurt others.
%4) Others start to dislike you, you notice it and it reinforces step 1. Now you’re again at step 2.
...
Even if you are helping others, you are doing it because \textit{you} wish to, not because you're sacrificing yourself for others.
The path of sacrifice leads to madness.
...
This is how it must be, and how it always has been, with regard to great and poignant art.
...
Well, you are a not dead yet person, which is everything, even if it seems like nothing in the moment.
